...
import { ArrowLeft, Target, Globe, Heart, Users } from 'lucide-react';
      ...
      <nav className="w-full px-6 py-4 flex justify-between items-center bg-primary">
        <div className="flex items-center space-x-8">
          <Link to="/" className="flex items-center">
            <Image 
              src="https://static.wixstatic.com/media/eafe55_b752d28a2040412d889baf70e2818e7a~mv2.png?id=logo-about"
              alt="JCI Ikeja Logo"
              width={140}
